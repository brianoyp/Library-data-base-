...
%>
	<form name="form1" method="get" onsubmit="return check_all_fields()" action="book_stats.jsp">
...
<%
	...
	String result = libraryUtilities.getBookStatistics(n, connector.con);
%>  
  	<p><%=result%></p> <BR>
  	<a href="book_stats.jsp"> Get Other Book Stats </a> <BR><BR>
<%
